...
module.exports = function BookshelfAdapter(Model, options, newHooks) {
  if (!Model) {
    throw new Error('Model required');
  }

  // if no hooks passed as argument use empty functions as default
  ...
  const proto = {
    async create(req, res) {
      try {
        ...
        hooks.create.after(savedModel, req);
